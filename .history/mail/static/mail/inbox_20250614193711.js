...
function open_email(id){
  ...
  .then(email => {
    ...
    document.querySelector('.ed-to').innerHTML = `<strong>To:</strong> ${email.recipient}`
    document.querySelector('.ed-subject').innerHTML = `<strong>Subject:</strong> ${email.subject}`
    document.querySelector('.ed-timestamp').innerHTML = `<strong>Timestamp:</strong> ${email.subject}`
